...
def encode_captions(imgs, params, wtoi):
    ...
    for i, img in enumerate(imgs):
        ...
        counter += n
    # print(caption_counter, zero_cnt)
...
if __name__ == "__main__":
    ...
    pars = {"input_json": 'wikijson_no_names.json', 'output_json': 'wikitalk_no_names.json', 'output_h5': 'wikitalk_no_names',
            'max_length': 16, 'images_root': '', 'word_count_threshold': 0}
    main(pars)

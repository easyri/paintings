...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', nargs='+', default='C:\\Users\\anke\\PycharmProjects\\pythonProject\\wikijson.json',
                        help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='wiki_captions4eval.json',

...
def main(params):
  ...
  myutils.pickle_dump({'document_frequency': ngram_words, 'ref_len': ref_len}, open(params['output_pkl']+'-words.p', 'wb'))
  myutils.pickle_dump({'document_frequency': ngram_idxs, 'ref_len': ref_len}, open(params['output_pkl']+'-idxs.p', 'wb'))
...
if __name__ == "__main__":
  ...
  pars = {'input_json': 'C:\\Users\\anke\\PycharmProjects\\pythonProject\\wikijson_no_names.json',
          'dict_json': 'C:\\Users\\anke\\PycharmProjects\\pythonProject\\wikitalk_no_names.json',
          'output_pkl': 'wiki-train_no_names', 'split': 'train'}
  main(pars)
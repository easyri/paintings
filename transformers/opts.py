...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='wikitalk.json',
                        help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='D:\\paintings\\resnet features_fc',
                        help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='D:\\paintings\\resnet features_att',
                        help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='',
                        help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='wikitalk_label.h5',
    ...
    parser.add_argument('--start_from', type=str, default=None,
                    ...
                    """)
    parser.add_argument('--checkpoint_path', type=str, default='save4',
                        help='directory to store checkpointed models')
    parser.add_argument('--cached_tokens', type=str, default='wiki-train-idxs.p',
    ...
    parser.add_argument('--dropout_aoa', type=float, default=0.1,
    ...
    parser.add_argument('--norm_att_feat', type=int, default=1,
    ...
    parser.add_argument('--drop_prob_lm', type=float, default=0.2,  # 0.5
    ...
    parser.add_argument('--label_smoothing', type=float, default=0,
                        help='')
    # action = 'store_true',
    parser.add_argument('--noamopt', default=False,
                        help='')
    ...
    parser.add_argument('--noamopt_factor', type=float, default=1,
                        help='')
    # action = 'store_true'
    parser.add_argument('--reduce_on_plateau', default=False,
                        help='')
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=3250,  # 2 times per epoch
    ...
    parser.add_argument('--losses_log_every', type=int, default=750,    # 10 times per epoch
    ...
    parser.add_argument('--bleu_reward_weight', type=float, default=1,
...
def add_eval_options(parser):
    ...
    parser.add_argument('--vis_dump_path', type=str, default='C:\\Users\\anke\\PycharmProjects\\pythonProject\\vis\\test4_test_folder')
    ...
    parser.add_argument('--image_folder', type=str, default='E:\\paintings\\cheese_test',     # 'D:\\paintings\\test'
